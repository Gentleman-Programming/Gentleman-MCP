...
import * as mcp_v1_mcp_pb from '../../mcp/v1/mcp_pb'; // proto import: "mcp/v1/mcp.proto"
...
export class HandshakeServiceClient {
  ...
  register(
    request: mcp_v1_mcp_pb.RegisterRequest,
    metadata?: grpcWeb.Metadata | null): Promise<mcp_v1_mcp_pb.RegisterResponse>;

  register(
    request: mcp_v1_mcp_pb.RegisterRequest,
    metadata: grpcWeb.Metadata | null,
    callback: (err: grpcWeb.RpcError,
               response: mcp_v1_mcp_pb.RegisterResponse) => void): grpcWeb.ClientReadableStream<mcp_v1_mcp_pb.RegisterResponse>;

  register(
    request: mcp_v1_mcp_pb.RegisterRequest,
    metadata?: grpcWeb.Metadata | null,
    callback?: (err: grpcWeb.RpcError,
               response: mcp_v1_mcp_pb.RegisterResponse) => void) {
  ...
  authenticate(
    request: mcp_v1_mcp_pb.AuthRequest,
    metadata?: grpcWeb.Metadata | null): Promise<mcp_v1_mcp_pb.AuthResponse>;

  authenticate(
    request: mcp_v1_mcp_pb.AuthRequest,
    metadata: grpcWeb.Metadata | null,
    callback: (err: grpcWeb.RpcError,
               response: mcp_v1_mcp_pb.AuthResponse) => void): grpcWeb.ClientReadableStream<mcp_v1_mcp_pb.AuthResponse>;

  authenticate(
    request: mcp_v1_mcp_pb.AuthRequest,
    metadata?: grpcWeb.Metadata | null,
    callback?: (err: grpcWeb.RpcError,
               response: mcp_v1_mcp_pb.AuthResponse) => void) {
    if (callback !== undefined) {
      return this.client_.rpcCall(
        this.hostname_ +
          '/mcp.v1.HandshakeService/Authenticate',
...
export class AgentServiceClient {
  ...
  singleChat(
    request: mcp_v1_mcp_pb.SingleChatRequest,
    metadata?: grpcWeb.Metadata | null): Promise<mcp_v1_mcp_pb.SingleChatResponse>;

  singleChat(
    request: mcp_v1_mcp_pb.SingleChatRequest,
    metadata: grpcWeb.Metadata | null,
    callback: (err: grpcWeb.RpcError,
               response: mcp_v1_mcp_pb.SingleChatResponse) => void): grpcWeb.ClientReadableStream<mcp_v1_mcp_pb.SingleChatResponse>;

  singleChat(
    request: mcp_v1_mcp_pb.SingleChatRequest,
    metadata?: grpcWeb.Metadata | null,
    callback?: (err: grpcWeb.RpcError,
               response: mcp_v1_mcp_pb.SingleChatResponse) => void) {
    if (callback !== undefined) {
      return this.client_.rpcCall(
        this.hostname_ +
          '/mcp.v1.AgentService/SingleChat',
